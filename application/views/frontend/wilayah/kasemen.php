    ...
    <div class="row" style="padding: 10px;">
        ...
        <form method="post" action="<?php echo base_url();?>home/submit_form/<?php echo $title;?>" class="form-1" />
            <div class="col-lg-3">
                ...
                <input type="hidden" name="wilayah" value="6">
                <?php
...
<script>
    ...
    var wilayah = "<?php echo $title; ?>";

    document.getElementById("nama_file").value = "PDF/PDF Tahun " + tahun + "/" + wilayah + "/Bidang " + bidang + " " + triwulan;
</script>
<script>
