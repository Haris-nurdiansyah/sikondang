...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><a href="<?php echo site_url('dashboard/edit/'.$row->id_user);?>"><i class="glyphicon glyphicon-edit"></i></a></td>
        <td><a href="#" class="hapus" kode="<?php echo $row->id_user;?>"><i class="glyphicon glyphicon-trash"></i></a></td>
    </tr>
    <?php endforeach;?>
</table>
